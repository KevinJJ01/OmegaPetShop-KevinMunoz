      ...
      <div className="card">
        <div className="card-body login-card-body">
          ...
          <div className="input-group mb-3">
              <input style={{color: "#239B56", borderColor: "#239B56"}} type="text" 
              ...
              <div className="input-group-append">
                <div className="input-group-text">
                  <span style={{color: "#239B56", borderColor: "#239B56"}} className="fas fa-user"></span>
                </div>
              </div>
            </div>
            <div className="input-group mb-3">
            ...
            <div className="input-group mb-3">
              ...
              <div className="input-group-append">
                <div className="input-group-text">
                  <span style={{color: "#239B56", borderColor: "#239B56"}} className="fas fa-lock"></span>
                </div>
              </div>
            </div>
            <div className="input-group mb-3">
          ...
          <div className="social-auth-links text-center mb-3">
            <button style={{backgroundColor: "#82E0AA", borderColor : "#82E0AA", color: "black"}} type="submit" className="btn btn-block btn-primary"> 
            Crear Cuenta
            </button>
            <Link to={"/"} style={{backgroundColor: "#82E0AA", borderColor : "#82E0AA", color: "black"}} type="submit" className="btn btn-block btn-danger" > Regresar al login
            </Link>
          </div>
          </form>
